...
class CartPage:
    def __init__(self,page):
        ...
        #self.order_navbar_btn = page.get_by_role('button',name=re.compile(r"Cart"))
        self.cart_navbar_btn = page.locator('button[routerlink ="/dashboard/cart"]')  #clicking cart on navbar
